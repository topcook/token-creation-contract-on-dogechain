 ...
 */
module.exports = {
  defaultNetwork: "dogechain_testnet",
  networks: {
    localhost: {
    ...
    dogechain_testnet: {
      url: "https://rpc-testnet.dogechain.dog/", //for dogechain test net
      chainId: 568, // for dogechain test net
      // gasPrice: 20000000000,
      accounts: {mnemonic: MNEMONIC}
    },
    dogechain_mainnet: {
      url: "https://rpc01-sg.dogechain.dog/", //for dogechain main net
      chainId: 2000, //for dogechain main net
      // gasPrice: 20000000000,
      accounts: {mnemonic: MNEMONIC}
    }
  },
